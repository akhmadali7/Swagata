...
import imageHero1 from "../../public/assets/landingpage/Image Hero1.jpg"
import imageHero2 from "../../public/assets/landingpage/Image Hero2.jpg"
    ...
    return (
        <div className="">
            <div className="bg-tertiary">
                <div className=" flex flex-col gap-y-[200px] sm:gap-y-[300px] sm:flex-row items-center align-top gap-x-6 pb-10 px-3 sm:px-6 md:px-16 lg:px-20 xl:px-40 2xl:px-96">
                    ...
                    <div className="bg-white rounded-xl w-full md:w-1/2 h-[300px] ">
                        ...
                        <div className=" h-[300px] rounded-b-xl">
                            <Images src={imageHero1} alt="Image Hero 1" className="rounded-b-xl" />
                        </div>
                    ...
                    <div className="bg-white rounded-xl w-full md:w-1/2 h-[300px]">
                        ...
                        <div className="h-[300px] rounded-b-xl">
                            <Images src={imageHero2} alt="Image Hero 2" className="rounded-b-xl" />
            ...
            <div className="flex flex-col  md:flex-row  gap-x-2 gap-y-3 py-10 pt-[200px] sm:pt-[200px] md:pt-[200px] lg:pt-[300px] px-3 sm:px-6 md:px-16 lg:px-20 xl:px-40 2xl:px-96">
